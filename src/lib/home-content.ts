...
const ABOUT_CARDS: Record<Locale, AboutCard[]> = {
  vi: [
    ...
    },
    {
      ...
      body: 'Phòng QC kiểm tra từng lô theo bốn chỉ tiêu: độ trắng, hàm lượng CaCO₃, độ ẩm và cỡ hạt D50 (3–20 µm). Mỗi lô xuất xưởng kèm COA và MSDS theo hệ thống ISO 9001:2015; sẵn sàng kiểm định độc lập qua SGS khi khách hàng yêu cầu.',
  ...
  en: [
    ...
    },
    {
      ...
      body: 'In-house QC tests every batch on four criteria: whiteness, CaCO₃ content, moisture and D50 particle size (3–20 µm). Every batch ships with COA and MSDS under ISO 9001:2015 — with independent SGS verification on request.',
      imageUrl: '/assets/kiem-dinh.jpg',
      facts: [
  ...
  zh: [
    ...
    {
      name: '质量检验',
      body: '内部QC按四项指标检测每一批次:白度、碳酸钙含量、水分和D50粒径(3–20 µm)。每批出厂附COA与MSDS(ISO 9001:2015体系),可按客户要求提供SGS独立检验。',
      imageUrl: '/assets/kiem-dinh.jpg',
      facts: [
