...
const STATS: Record<Locale, ProductsStatsSection> = {
  ...
  en: {
    items: [
      ...
      { value: '4–20µm', label: 'Particle size' },
    ...
    items: [
      {
        number: '01',
        title: 'Bột đá CaCO₃',
        desc: 'Coated · Uncoated · 4–20 µm — phụ gia cho nhựa, sơn, giấy, thức ăn chăn nuôi.',
    ...
    items: [
      {
        number: '01',
        title: 'CaCO₃ powder',
        desc: 'Coated · Uncoated · 4–20 µm — for plastics, paint, paper, animal feed.',
        imageUrl: '/assets/bot-caco3-sieu-min.webp',
        anchor: '#cat-powder',
      },
      {
    ...
    items: [
      {
        number: '01',
        title: '碳酸钙粉',
        desc: '涂层 · 未涂层 · 4–20µm — 适用于塑料、涂料、造纸、动物饲料。',
        imageUrl: '/assets/bot-caco3-sieu-min.webp',
        anchor: '#cat-powder',
      },
      {
...
const SPEC_TABLE: Record<Locale, ProductsSpecTableSection> = {
  vi: {
    ...
    rows: [
      ...
      { label: 'Cỡ hạt D50', coated: '4–20', uncoated: '5–25', unit: 'µm' },
  ...
  en: {
    ...
    rows: [
      ...
      { label: 'Particle size D50', coated: '4–20', uncoated: '5–25', unit: 'µm' },
  ...
  zh: {
    ...
    rows: [
      ...
      { label: '粒径 D50', coated: '4–20', uncoated: '5–25', unit: 'µm' },
  ...
  vi: {
    ...
    steps: [
      ...
      },
      {
        k: '02',
        t: 'Nghiền siêu mịn',
        d: '06 dây chuyền nghiền khô công nghệ Châu Âu cho cỡ hạt D50 từ 4 tới 20 µm — đồng đều theo từng lô sản xuất.',
      },
      {
        k: '03',
        t: 'Phủ Stearic Acid',
  ...
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        d: '6 European-spec dry-grinding lines deliver D50 particle sizes from 4 to 20 µm — uniform batch after batch.',
      },
      {
        k: '03',
  ...
  zh: {
    ...
    steps: [
      ...
      },
      {
        k: '02',
        t: '超细研磨',
        d: '6条欧洲标准干法研磨线,D50粒径4至20 µm — 批批均匀。',
      },
      {
        k: '03',
        t: '硬脂酸涂层',
