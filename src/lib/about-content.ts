...
const VALUES: Record<Locale, AboutValuesSection> = {
  vi: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Dây chuyền nghiền và phủ Stearic Acid theo công nghệ Châu Âu, cỡ hạt D50 kiểm soát trong dải 3–20 µm. Mỗi lô qua đủ bốn chỉ tiêu QC trước khi xuất xưởng.',
        icon: 'spark',
      },
      {
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'European-spec grinding and stearic-acid coating lines hold D50 particle size within 3–20 µm. Every batch passes four QC criteria before leaving the plant.',
        icon: 'spark',
      },
      {
  ...
  zh: {
    ...
    items: [
      ...
      {
        name: '精密技术',
        body: '欧洲标准研磨与硬脂酸涂层生产线,D50粒径控制在3–20 µm。每批次出厂前通过四项QC指标。',
        icon: 'spark',
      },
      {
        name: '准时交付',
